...
const CANVASES_DATA = {
  ai_power_grid: {
    ...
    nodes: {
      ...
      ems_software: { id: 'ems_software', name: '지능형 에너지 관리 SW', x: 580, y: 360, w: 180, h: 50, description: '배전 전력 부하 데이터를 상시 분석 제어하는 솔루션.', instruments: [{ name: '슈나이더 (Schneider)', ticker: 'SU.PA', price: '215.3€', change: '+0.9%' }], evidence: { grade: 'B', date: '2026-06-04', type: 'Schneider DCIM 소개' } },
  ...
  hbm_packaging: {
    ...
    nodes: {
      ...
      // 2단계: 가공/부품 (X = 320)
      tc_bonder: { id: 'tc_bonder', name: '듀얼 TC 본더 장비', x: 320, y: 40, w: 180, h: 50, description: 'TSV 구리 기둥을 열압착하여 D램을 적층 접합하는 초정밀 본딩 장비.', instruments: [{ name: '한미반도체', ticker: '042700', price: '162,000원', change: '+6.8%' }], evidence: { grade: 'A', date: '2026-06-04', type: '한미반도체 공급계약 체결 공시(DART)' } },
      ...
      // 3단계: 시스템 완제품 (X = 580)
      hbm3e_stack: { id: 'hbm3e_stack', name: 'HBM3E D램 스택 완제품', x: 580, y: 40, w: 180, h: 50, description: '8단/12단 MR-MUF 공정으로 패킹된 고대역폭 메모리 유닛.', instruments: [{ name: 'SK하이닉스', ticker: '000660', price: '203,500원', change: '+3.2%' }, { name: '삼성전자', ticker: '005930', price: '77,400원', change: '+0.8%' }], evidence: { grade: 'B', date: '2026-06-04', type: 'SK하이닉스 공식 프레스 뉴스 및 분기보고서' } },
  ...
  datacenter_infra: {
    ...
    nodes: {
      ...
      // 2단계: 가공/부품 (X = 320)
      smart_pdu: { id: 'smart_pdu', name: '지능형 PDU 분배 장치', x: 320, y: 40, w: 180, h: 50, description: '서버 랙 개별 장치 단위의 소비 전력을 즉시 차단 제어하는 콘센트.', instruments: [{ name: 'LS ELECTRIC', ticker: '010120', price: '218,000원', change: '+2.1%' }], evidence: { grade: 'B', date: '2026-06-04', type: 'LS ELECTRIC 제품 사양서 및 데이터센터 카탈로그' } },
      ...
      dcim_system: { id: 'dcim_system', name: 'DCIM 전력/냉각 연동 관제', x: 840, y: 200, w: 180, h: 50, description: 'PUE/WUE 최적화를 위해 환경 지표를 중앙 모니터링하는 SW.', instruments: [{ name: '슈나이더 (Schneider)', ticker: 'SU.PA', price: '215.3€', change: '+0.9%' }], evidence: { grade: 'A', date: '2026-06-04', type: 'EcoStruxure 데이터센터 매뉴얼' } },
