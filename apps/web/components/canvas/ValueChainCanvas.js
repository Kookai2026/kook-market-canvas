...
const CANVASES_DATA = {
  ...
  datacenter_infra: {
    ...
    nodes: {
      ...
      // 2단계: 가공/부품 (X = 320)
      smart_pdu: { id: 'smart_pdu', name: '지능형 PDU 분배 장치', x: 320, y: 40, w: 180, h: 50, description: '서버 랙 개별 장치 단위의 소비 전력을 실시간 차단 제어하는 콘센트.', instruments: [{ name: 'LS ELECTRIC', ticker: '010120', price: '218,000원', change: '+2.1%' }], evidence: { grade: 'B', date: '2026-06-04', type: 'LS ELECTRIC 제품 사양서 및 데이터센터 카탈로그' } },
